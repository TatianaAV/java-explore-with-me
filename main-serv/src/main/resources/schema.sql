...
create table if not exists public.compilations_title
(
...
(
    ...
    CONSTRAINT FK_COMPILATIONS_ON_EVENT FOREIGN KEY (event_id) REFERENCES public.events (event_id),
    CONSTRAINT FK_COMPILATIONS_ON_ID FOREIGN KEY (title_id) REFERENCES public.compilations_title (title_id)
);
...
(
    ...
    CONSTRAINT FK_PARTICIPATIONS_ON_EVENT FOREIGN KEY (event_id) REFERENCES public.events (event_id),
    CONSTRAINT FK_PARTICIPATIONS_ON_REQUESTER FOREIGN KEY (requester_id) REFERENCES public.users (id)
);
